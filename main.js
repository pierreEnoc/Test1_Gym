( function(){
    ...
    function showProfile(user){
        ...
        <ul class="List-group List-group-flush">
         ...
         <li class="List-grou-item">commit<span class="badge badge-info">${user.committer}</span></li> 
        </ul>
        <div class="card-body">
    ...
    function showCommits (commits){
        ...
        commits.innerHTML =`<div class="row mt-3"> 
        <div class="col-md-4">
        <div class="card" style="width:18rem;">
        <img class="card-img.top" src="${user.gists_url}" />
        <ul class="List-group List-group-flush">
         <li class="List-grou-item">Repositorios: <span class="badge badge-success">${user.public_commits}</span></li>   
      
        </ul>
        <div class="card-body">
         <a href="${commits.html_url}" target="_blank" class="btn btn-warning btn-block"> ver perfil</a>
     </div>
    </div>
    </div>
    <div class="col-md-8">
